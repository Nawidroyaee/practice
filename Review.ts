...
import { createBigIntLiteral, createImportSpecifier } from "typescript";
...
const invAbbas = new Invoice ("Abbas", "Finished Auth Service", 500);
const invHakima = new Invoice ("Hakima", "Finished front end data picker, including sign up with G", 500)


console.log(invAbbas, invHakima)